...
<html lang="en">
  <head>
    ...
    <title>Dashboard | KIA Bamboo Art</title>
  ...
  <body>
      ...
      <div class="d-flex" id="wrapper" data-aos="fade-right">
        ...
        <div class="border-right" id="sidebar-wrapper">
          <div class="sidebar-heading text-center">
            <img src="../assets/images/logo-dashboard.png" alt="" class="my-4 w-50" />
          </div>
          <div class="list-group list-group-flush">
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                ...
                <a class="dropdown-item" href="?page=transactions-rekap">Rekap Penjualan</a>
        ...
        <div id="page-content-wrapper">
          ...
          if (isset($page)) {
            ...
            } elseif ($page == 'transactions-rekap') {
              include 'transaction/dashboard-transactions-rekap.php';
    ...
    function ExportToExcel(type, fn, dl) {
       ...
       return dl ?
         ...
         XLSX.writeFile(wb, fn || ('RekapPenjualan.' + (type || 'xlsx')));
    }
    </script>
