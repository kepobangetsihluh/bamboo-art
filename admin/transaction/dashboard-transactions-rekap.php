<!--
    CREATED 11/8/2022 MUHAMMAD FIKRI ARZYAH
    DONT DELETE THIS OR YOU CANT CLAIM GUARANTEE   
-->
<nav
...
<div class="section-content section-dashboard-home" data-aos="fade-up">
  <div class="container-fluid">
    <div class="dashboard-heading">
      <h2 class="dashboard-title">Rekap Transaction</h2>
      <p class="dashboard-subtitle">This is menu for Rekap transactions </p>
    </div>
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <button class="btn btn-warning" type="button" button onclick="ExportToExcel('xlsx')">Export</button><br>
                    <table class="table table-striped table-hover" id="table">
                      ...
                      <tbody>
                        <?php 
                          ...
                          $query = "SELECT * FROM transactions INNER JOIN users ON transactions.user_id = users.id_user INNER JOIN rekening_numbers ON transactions.rekening_id = rekening_numbers.id_rekening WHERE transaction_status in ('KONFIRMASI','TERKONFIRMASI','TERKIRIM')";
