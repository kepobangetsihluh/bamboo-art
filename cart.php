...
if (isset($_POST['checkout'])){
  ...
  $weight = $_POST["weight"];
  $delivered = isset($_POST["delivered"] ) ? $_POST["delivered"] : 0;
  $photo = "";
...
<head>
  ...
  <title>Cart | KIA Bamboo Art</title>
                ...
                <?php foreach ($carts as $cart) : ?>
                  ...
                  <tr>
                    ...
                    <form action="" method="POST">
                      ...
                      <input type="hidden" name="stokProduct" value="<?= $cart["banyak"]; ?>">
                      <input type="hidden" name="idProduct" value="<?= $cart["product_id"]; ?>">
