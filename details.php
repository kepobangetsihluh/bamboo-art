...
$photos = query("SELECT * FROM products_galleries WHERE product_id = $idProduct")[0];
...
<head>
  ...
  <title>Details | KIA Bamboo Art</title>
      ...
      <section class="store-description">
        <div class="container">
          <div class="row">
            ...
            <img src="/bamboo_art/assets/images/<?php echo $photos['photos']; ?>" width="75%" height="75%">
              <p>
  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-12">
          <p class="pt-4 pb-2">
            &copy; 2022 Copyright by KIA Bamboo Art. All Rights Reserved.
          </p>
        </div>
      </div>
    </div>
